...
* SSL-сертификат: TLS Certificate Issued by Let's Encrypt, срок действия до 1 октября 2024 года.
* Уязвимости: нет известных
* Безопасные заголовки HTTP: Https, HSTS.
