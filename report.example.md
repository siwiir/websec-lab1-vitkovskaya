1.1 Доменное имя
Доменное имя сайта — ktkv.dev, также используются поддомены:

`ac-server.ktkv.dev, ii.ktkv.dev, jf.ktkv.dev, ktkv.dev, lw.ktkv.dev, nc.ktkv.dev, og.ktkv.dev, vw.ktkv.dev`

1.2 IP-адрес
Основной IP-адрес сайта — 92.124.140.111, зарегистрирован в RU

1.3 Время создания домена
Домен ktkv.dev был зарегистрирован 25.11.2023 года.

1.4 Срок действия домена
Регистрация домена действительна до 25.11.2024 года.
...
`cartman.ns.cloudflare.com.`, предоставляемые Amazon Web Services.

2.2 Топология сети
Серверы сайта расположены в United States, Netherlands and Russian Federation

2.3 Подсети и CIDR
Сайт использует IP-адреса, принадлежащие подсетям 162.159.44.219 and 108.162.192.200 
...
Используются данные по стандарту schema.org для продуктов и статей. 
