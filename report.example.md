...
1.2 IP-адрес
Основной IP-адрес сайта — 92.124.140.111, зарегистрирован в RU, дата-центр Amazon Web Services (AWS). Используется система распределения нагрузки для повышения отказоустойчивости.
